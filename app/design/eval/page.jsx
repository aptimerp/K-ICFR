...
const TABS = [
  { id: "design-perform", label: "설계평가 수행" },
  { id: "rcm-confirm",    label: "RCM 확정" },
];
...
function EvalPageContent() {
  const [activeTab, setActiveTab] = useState("design-perform");
  return (
    <AppLayout>
      <div className="max-w-6xl mx-auto">
        <div className="mb-6">
          <h1 className="text-xl font-bold text-gray-900">설계평가</h1>
          <p className="text-sm text-gray-500 mt-1">설계평가 수행 및 RCM을 최종 확정합니다</p>
        </div>
...
export default function DesignEvalPage() {
